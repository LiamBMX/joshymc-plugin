...
class BunnyHelmet : CustomItem() {
    override val id = "bunny_helmet"
    override val material = Material.DIAMOND_HELMET
    override val hasGlint = true
    override val displayName: Component = Component.text("Bunny Helmet", TextColor.color(0xFFB6C1))
    ...
    override fun applyMeta(meta: ItemMeta) {
        meta.setItemModel(NamespacedKey(Joshymc.instance, "bunny_helmet"))
        ...
        equippable.slot = org.bukkit.inventory.EquipmentSlot.HEAD
